...
while True:
        ...
        user_input = input(" Make your movement:u for upward direction, d for downwards, l for left and r for Right:")
        ...
        for i in range(0,4):
            ...
            for j in range(0,4):
                ...
                if myArray[i][j]==0:
                    ...
                    listforj.append(j)
                if myArray[i][j]==2048:
                    print('Congratulations, you have summed up a 2048 tile')
                    break
